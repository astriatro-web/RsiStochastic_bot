...
def run_sniper():
    ...
    # --- 3. TQQQ 200일선 실시간 전략 ---
    tq_obj = yf.Ticker("TQQQ")
    tq_now = tq_obj.fast_info['last_price']
    tq_sma200 = float(close_df["TQQQ"].rolling(window=200).mean().iloc[-1])
    ...
    msg += f"\n🚀 TQQQ 특공대 신호: {'🔥 진입!' if q_rsi < 35 and vix > 28 else '💤 없음'}"
    msg += f"\n━━━━━━━━━━━━━━━"
